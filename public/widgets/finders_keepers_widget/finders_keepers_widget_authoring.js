...
(function () {
  ...
  var authoring = angular.module('finders_keepers_widget_authoring', [
    'angularWidget',
    'ngAnimate',
    'pick_and_stack',
    'juice',
  ...
  authoring.controller('GameContentCtrl', ['$scope', '$controller', 'ConfirmModal', 'GameData', 'FileService', 'ASSETS',  GameContentController]);

  function GameContentController($scope, $controller, ConfirmModal, GameData, FileService, ASSETS) {
    angular.extend(this, $controller('GameContentAuthoringMixin', {$scope: $scope}), {
      gameName: 'pick_and_stack',
      header: 'Finders Keepers Authoring',
